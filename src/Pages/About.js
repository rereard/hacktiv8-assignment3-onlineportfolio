const About = () => {
    return(
        <div className="w-9/12 flex flex-col justify-center text-orange-600 text-2xl font-bold">
            ...
            <br />
            <p>Hello! My name is Muhammad Rere Ardany, undergraduate Informatics Engineering student at Dian Nuswantoro University. You can look more about me at the links below.</p>
